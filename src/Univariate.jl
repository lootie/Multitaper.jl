...
See also: [`dpss_tapers`](@ref), [`MTSpectrum`](@ref),
[`mdmultispec`](@ref), [`mdmultispec_noadapt`](@ref), [`mdslepian`](@ref)
"""
...
function welch(S1, nsegments, overlap=0.5; NW=4.0, K=6,
  ...
  if seg_len < K 
    throw(ArgumentError("Requested number of tapers ($K) exceeds length of segments ($seg_len)."))
  end
